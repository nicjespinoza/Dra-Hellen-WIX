        ...
        wixData.query("User")
            ...
            .then((results) => {
                ...
                if (results.items.length > 0) {
                    ...
                    // Verificar el género y habilitar el botón según corresponda
                    if (sexo === "Masculino") {
...
function botoncontinuar() {
    ...
    $w("#nextButton5").onClick(function () {
        guardar5()
    });
}
...
function validarinput() {
    ...
    $w("#ipt1, #ipt3, #ipt4, #ipt5, #ipt6, #ipt7, #ipt8, #ipt9, #ipt10, #ipt11, #iptfrijoles, #ipt12, #ipt13, #ipt14, #ipt15, #ipt16").onChange(function () {
        if ($w("#ipt1").value.length > 0 &&
            $w("#ipt3").value.length > 0 &&
            $w("#ipt4").value.length > 0 &&
            $w("#ipt5").value.length > 0 &&
            $w("#ipt6").value.length > 0 &&
            $w("#ipt7").value.length > 0 &&
            $w("#ipt8").value.length > 0 &&
            $w("#ipt9").value.length > 0 &&
            $w("#ipt10").value.length > 0 &&
            $w("#ipt11").value.length > 0 &&
            $w("#iptfrijoles").value.length > 0 &&
            $w("#ipt12").value.length > 0 &&
            $w("#ipt13").value.length > 0 &&
            $w("#ipt14").value.length > 0 &&
            $w("#ipt15").value.length > 0 &&
            $w("#ipt16").value.length > 0
            ...
            $w('#txthora2').value = "Almuerzo"
            $w("#txtmerienda2").value = "Merienda Almuerzo"

            $w('#txthora3').value = "Cena"
            $w("#txtmerienda3").value = "Merienda Cena"

            $w('#txthora1').value = "Desayuno"
            $w("#txtmerienda1").value = "Merienda Desayuno"

        } else {

            $w("#nextButton1").disable();
            $w('#txtmens1').show()
        }
    });
    ...
    $w("#txthora1, #txtalimento1, #txtcantidad1, #txtmerienda1, #txtmeriendaalime1, #txtmeriendacantida1, #txthora2, #txtalimento2, #txtcantidad2, #txtmerienda2, #txtmeriendaalime2, #txtmeriendacantida2, #txthora3, #txtalimento3, #txtcantidad3, #txtmerienda3, #txtmeriendaalime3, #txtmeriendacantida3").onChange(function () {
        if ($w("#txthora1").value.length > 0 &&
            $w("#txtalimento1").value.length > 0 &&
            $w("#txtcantidad1").value.length > 0 &&
            $w("#txtmerienda1").value.length > 0 &&
            $w("#txtmeriendaalime1").value.length > 0 &&
            $w("#txtmeriendacantida1").value.length > 0 &&
            $w("#txthora2").value.length > 0 &&
            $w("#txtalimento2").value.length > 0 &&
            $w("#txtcantidad2").value.length > 0 &&
            $w("#txtmerienda2").value.length > 0 &&
            $w("#txtmeriendaalime2").value.length > 0 &&
            $w("#txtmeriendacantida2").value.length > 0 &&
            $w("#txthora3").value.length > 0 &&
            $w("#txtalimento3").value.length > 0 &&
            $w("#txtcantidad3").value.length > 0 &&
            $w("#txtmerienda3").value.length > 0 &&
            $w("#txtmeriendaalime3").value.length > 0 &&
            $w("#txtmeriendacantida3").value.length > 0
    ...
    $w("#ipt17,#ipt18, #ipt19, #ipt20, #ipt21, #ipt22, #ipt23, #ipt24, #ipt25, #ipt26, #ipt27, #ipt28, #ipt29, #ipt31, #ipt32, #ipt33, #ipt34").onChange(function () {
        if ($w("#ipt17").value.length > 0 &&
            $w("#ipt18").value.length > 0 &&
            $w("#ipt19").value.length > 0 &&
            $w("#ipt20").value.length > 0 &&
            $w("#ipt21").value.length > 0 &&
            $w("#ipt22").value.length > 0 &&
            $w("#ipt23").value.length > 0 &&
            $w("#ipt24").value.length > 0 &&
            $w("#ipt26").value.length > 0 &&
            $w("#ipt27").value.length > 0 &&
            $w("#ipt28").value.length > 0 &&
            $w("#ipt29").value.length > 0 &&
            $w("#ipt30").value.length > 0 &&
            $w("#ipt31").value.length > 0 &&
            $w("#ipt32").value.length > 0 &&
            $w("#ipt33").value.length > 0 &&
            $w("#ipt34").value.length > 0
    ...
    $w("#ipthabit1, #ipthabit2, #ipthabit3, #ipthabit4, #ipthabit5, #ipthabit6, #ipthabit7, #ipthabit8, #ipthabit9, #ipthabit10, #ipthabit11, #ipthabit12, #ipthabit13, #ipthabit14, #ipthabit15, #ipthabit16, #ipthabit17, #ipthabit18, #ipthabit19, #ipthabit20, #ipthabit21, #ipthabit22, #ipthabit23, #ipthabit24, #ipthabit25").onChange(function () {
        if ($w("#ipthabit1").value.length > 0 &&
            $w("#ipthabit2").value.length > 0 &&
            $w("#ipthabit3").value.length > 0 &&
            $w("#ipthabit4").value.length > 0 &&
            $w("#ipthabit5").value.length > 0 &&
            $w("#ipthabit6").value.length > 0 &&
            $w("#ipthabit7").value.length > 0 &&
            $w("#ipthabit8").value.length > 0 &&
            $w("#ipthabit9").value.length > 0 &&
            $w("#ipthabit10").value.length > 0 &&
            $w("#ipthabit11").value.length > 0 &&
            $w("#ipthabit12").value.length > 0 &&
            $w("#ipthabit13").value.length > 0 &&
            $w("#ipthabit14").value.length > 0 &&
            $w("#ipthabit15").value.length > 0 &&
            $w("#ipthabit16").value.length > 0 &&
            $w("#ipthabit17").value.length > 0 &&
            $w("#ipthabit18").value.length > 0 &&
            $w("#ipthabit19").value.length > 0 &&
            $w("#ipthabit20").value.length > 0 &&
            $w("#ipthabit21").value.length > 0 &&
            $w("#ipthabit22").value.length > 0 &&
            $w("#ipthabit23").value.length > 0 &&
            $w("#ipthabit24").value.length > 0 &&
            $w("#ipthabit25").value.length > 0

        ) {
            $w("#nextButton4").enable();
            $w('#txtmens4').hide()

        } else {

            $w("#nextButton4").disable();
            $w('#txtmens4').show()
        }
    });
    ...
    $w("#iptfre1, #iptfre2, #iptfre3, #iptfre4, #iptfre5, #iptfre6, #iptfre7, #iptfre8, #iptfre9, #iptfre10, #iptfre11, #iptfre12, #iptfre13, #iptfre14, #iptfre15, #iptfre16, #iptfre17, #iptfre18, #iptfre19, #iptfre20, #iptfre21, #iptfre22, #iptfre23, #iptfre24, #iptfre25, #iptfre26").onChange(function () {
        if ($w("#iptfre1").value.length > 0 &&
            $w("#iptfre2").value.length > 0 &&
            $w("#iptfre3").value.length > 0 &&
            $w("#iptfre4").value.length > 0 &&
            $w("#iptfre5").value.length > 0 &&
            $w("#iptfre6").value.length > 0 &&
            $w("#iptfre7").value.length > 0 &&
            $w("#iptfre8").value.length > 0 &&
            $w("#iptfre9").value.length > 0 &&
            $w("#iptfre10").value.length > 0 &&
            $w("#iptfre11").value.length > 0 &&
            $w("#iptfre12").value.length > 0 &&
            $w("#iptfre13").value.length > 0 &&
            $w("#iptfre14").value.length > 0 &&
            $w("#iptfre15").value.length > 0 &&
            $w("#iptfre16").value.length > 0 &&
            $w("#iptfre17").value.length > 0 &&
            $w("#iptfre18").value.length > 0 &&
            $w("#iptfre19").value.length > 0 &&
            $w("#iptfre20").value.length > 0 &&
            $w("#iptfre21").value.length > 0 &&
            $w("#iptfre22").value.length > 0 &&
            $w("#iptfre23").value.length > 0 &&
            $w("#iptfre24").value.length > 0 &&
            $w("#iptfre25").value.length > 0 &&
            $w("#iptfre26").value.length > 0
        ...
        $w("#ipthabit26, #ipthabit27, #ipthabit28, #iptfre26, #iptfre27, #iptfre28").onChange(function () {
            if ($w("#ipthabit26").value.length > 0

                &&
                $w("#ipthabit27").value.length > 0 &&
                $w("#ipthabit28").value.length > 0 &&
                $w("#iptfre26").value.length > 0 &&
                $w("#iptfre27").value.length > 0 &&
                $w("#iptfre28").value.length > 0
    ...
    $w("#checkboxGroup1, #checkboxGroup2, #checkboxGroup3, #checkboxGroup4, #checkboxGroup5, #checkboxGroup6").onChange(function () {
        ...
        if ($w("#checkboxGroup1").value.length > 3

            &&
            $w("#checkboxGroup2").value.length > 3 &&
            $w("#checkboxGroup3").value.length > 3 &&
            $w("#checkboxGroup5").value.length > 3 &&
            $w("#checkboxGroup6").value.length > 3

        ) {
            $w("#nextButton5").enable();
            $w('#txtmens5').hide()

        } else {

            $w("#nextButton5").disable();
            $w('#txtmens5').show()
        }
    });

    $w("#ipt35,#ipt36, #ipt37, #ipt38, #ipt39, #ipt40, #ipt41, #ipt42, #ipt43").onChange(function () {
        if ($w("#ipt35").value.length > 0 &&
            $w("#ipt36").value.length > 0 &&
            $w("#ipt37").value.length > 0 &&
            $w("#ipt38").value.length > 0 &&
            $w("#ipt39").value.length > 0 &&
            $w("#ipt40").value.length > 0 &&
            //$w("#ipt41").value.length > 0 &&
            $w("#ipt42").value.length > 0 
            //$w("#ipt43").value.length > 0
    ...
    $w("#iptimagenprincipal,iptimagen1,iptimagen2").onChange(function () {
        ...
        if ($w("#iptimagenprincipal").value.length > 0 &&
            $w("#iptimagen1").value.length > 0 &&
            $w("#iptimagen2").value.length > 0
    ...
    wixData.query("historia")
        ...
        .then((results) => {
            ...
            if (item) {
                ...
                item.msDe4TiposDeGrasas = $w("#checkboxGroup6").value
    ...
    wixData.query("historia")
        ...
        .then((results) => {
            ...
            if (item) {
                ...
                //item.aplicacionesdesefuimiento = $w("#ipt41").value
                item.estaconciente = $w("#ipt42").value
                item.conociodra = $w("#checkboxGroup7").value
                //item.cadaCuantoLeGustaraRecibirMensajesDeLaDra = $w("#ipt43").value
                ...
                wixData.update("historia", item)
                    .then(() => {
                        ...
                        $w("#bt6").show();
                         $w("#bt5").hide();
                        $w("#anchor1").scrollTo();
                        $w('#txtmens6').text = " Su informacion se guardo con exito"
                        $w('#txtmens6').show()
                        $w('#videoPlayer1').play()
